...
CREATE INDEX IF NOT EXISTS idx_translations_english ON translations USING gin(to_tsvector('cantonese', cantonese));
CREATE INDEX IF NOT EXISTS idx_translations_chinese_text ON translations(chinese);
CREATE INDEX IF NOT EXISTS idx_translations_english_text ON translations(cantonese);
